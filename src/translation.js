const data = {
  en: {
    navbar: {
      ...
      ticketsUrl: 'https://www.eventbrite.co/e/pycon-colombia-2025-tickets-1271703351959'
    },
    landing: {
    ...
    callForProposals: {
      ...
      frequentQuestion: {
        ...
        topics: {
          ...
          linkText: 'here',
          text2: 'We like to see any kind of proposal related to the following topics:',
          mainTopics: [
            'Data Science',
            'Machine Learning',
            'Deep Learning',
    ...
    codeOfConductEnforcementProcedure: {
      ...
      conflictInterestExamplesIntro: 'Examples of conflicts of interest include:',
      ...
      possiblePrivateResponsesHeader: 'Possible private responses to an incident include:',
    ...
    footer: {
      ...
      codeOfConductEnforcementProcedure: 'Code of Conduct Enforcement Procedure',
  ...
  es: {
    ...
    codeOfConductEnforcementProcedure: {
      ...
      conflictInterestExamplesIntro: 'Ejemplos de conflictos de interés incluyen:',
      conflictInterestExamples: [
    ...
    scholarships: {
      ...
      paragraph4Text: 'Si quieres aplicar, por favor ingresa a este formulario:',
      formLink: 'https://forms.gle/EnSffxKcuzu4yugdA',
    ...
    footer: {
      ...
      codeOfConductEnforcementProcedure: 'Procedimiento de aplicación del Código de Conducta',
