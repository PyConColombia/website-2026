...
const components: MDXRemoteProps["components"] = {
  ...
  code: ({ children }) => (
    <code className="bg-muted rounded font-mono text-sm">{children}</code>
  ),
};
