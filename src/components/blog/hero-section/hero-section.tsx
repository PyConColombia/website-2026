...
const HeroSection = ({ posts }: { posts: PostMetadata[] }) => {
  return (
    <section
      id="home"
      className="relative px-4 py-8 sm:px-6 sm:py-16 lg:px-8 lg:py-24"
    >
              ...
              <Card className="group h-full shadow-none">
                <CardContent className="flex h-full flex-col gap-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className="text-primary bg-primary/10 h-fit text-sm font-medium">
                      {post.category}
                    </Badge>
                  </div>
                  ...
                  <p className="flex flex-1 items-end font-medium">
                    {post.author?.name}
                  </p>
                </CardContent>
              </Card>
                ...
                <Card className="group py-5 shadow-none">
                  <CardContent className="flex justify-between gap-6 max-sm:flex-col-reverse">
                    <div className="flex flex-1 flex-col justify-center gap-3.5">
                      ...
                      <div>
                        <CardTitle className="mb-1.5 line-clamp-1 text-base font-medium">
                          {post.title}
                        </CardTitle>
