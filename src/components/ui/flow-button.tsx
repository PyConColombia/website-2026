...
function PrimaryFlowButton({
  ...
  return (
    <div
      className={cn(
        "ring-primary/60 relative isolate w-fit overflow-hidden rounded-lg ring-2",
        className,
      )}
    >
      <Button
...
function SecondaryFlowButton({
  ...
  return (
    <div
      className={cn(
        "ring-secondary/60 relative isolate w-fit overflow-hidden rounded-lg ring-2",
        className,
      )}
    >
      <Button
...
export { type FlowButtonProps, PrimaryFlowButton, SecondaryFlowButton };
